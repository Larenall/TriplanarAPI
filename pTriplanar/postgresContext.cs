...
namespace pTriplanar
{
    public partial class postgresContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseNpgsql("Server=triplanar.postgres.database.azure.com;Username=larenall@triplanar;Database=postgres;Port=5432;Password=C9s0v0yf;SSLMode=Prefer");
            }
        }
